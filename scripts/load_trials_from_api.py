...
def _execute_batch_inserts(cursor, sql_batch: list, trials_collection, vector_batch: list):
    ...
    try:
        ...
        sql = f"INSERT INTO trials (id, title, status, phases, summary, conditions, interventions, source_url, inclusion_criteria, exclusion_criteria) VALUES ({placeholders})"
...
def main():
    ...
    with DatabaseConnections() as db_manager:
        ...
        logging.info(f"Starting data load. Page limit set to: {args.limit}")
